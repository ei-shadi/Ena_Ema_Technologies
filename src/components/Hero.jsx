...
const Hero = () => {
  return (
    <section className="min-h-screen w-full relative bg-[#151f1b] px-5 md:mx-0">
      <div
      ...
      <div className="absolute z-10 top-[10%] md:top-[15%] left-1/2 -translate-x-1/2 ">
        ...
        <div className="mb-12">
          ...
          <div>
            ...
            <p className="text-[#F5F5F5] text-xs md:text-lg text-center md:w-[614px] lg:max-w-[840px] mx-auto">Stop wasting traffic on generic pages. We deliver premium, conversion-focused landing pages designed, developed, and launched in just 5 days.</p>
          </div>
        </div>
        ...
        <div className="">
          ...
          <div className="border-[1px] border-[#2A3C36] p-4 md:p-9 w-[340px] md:w-[614px] lg:w-[794px] mx-auto rounded-lg shadow-2xl shadow-[rgba(31,255,165,0.1)] ">
            {/* Input fields */}
            <div className=" flex flex-col md:flex-row justify-center items-center gap-4 mb-6">
              ...
              <div className="flex items-center relative">
                ...
                <input type="text"
                  className="py-[18px] pl-10 pr-32 md:pr-0 lg:pr-14 text-xs  text-[#B2B2B2] border-[1px] border-[#2A3C36] rounded-[4px] focus:outline-none focus:border-[#1FFFA5]"
            ...
            {/* Button */}
            <div className="w-[300px] mx-auto md:w-full">
              <Button>
          ...
          {/* Text & Icons */}
          <div className="flex flex-col md:flex-row md:items-center justify-center px-4 mt-4 max-w-[630px] mx-auto gap-0 md:gap-16">
            <div className="flex items-center gap-24 md:gap-16">
              {/* Lock Icon */}
