      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-2 lg:gap-9'>
        ...
        <div className="p-6 bg-[#192420] rounded-lg">
          ...
          <div className="text-left">
            ...
            <p className="text-sm md:text-xs lg:text-sm text-[#B2B2B2] md:w-[152px] lg:w-full max-w-[328px]">Designs based on 100+ tested layouts that actually convert visitors into customers.</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#192420] rounded-lg">
          ...
          <div className="text-left">
            ...
            <p className="text-sm md:text-xs lg:text-sm text-[#B2B2B2] md:w-[152px] lg:w-full max-w-[328px]">Modern, premium, and tailored for your brand - without the agency price tag.</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#192420] rounded-lg">
          ...
          <div className="text-left">
            ...
            <p className="text-sm md:text-xs lg:text-sm text-[#B2B2B2] md:w-[152px] lg:w-full max-w-[328px]">Our pages consistently outperform industry averages for conversions.</p>
          </div>
        </div>
      </div>
    </section>
