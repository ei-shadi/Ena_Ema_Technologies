...
const FromIdea = () => {
  return (
    <section className="relative text-[#F5F5F5] text-center">
      {/* Left-side glow */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#1FFFA5] rounded-full blur-[180px] opacity-20"></div>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-9 lg:gap-6 md:w-[88%] lg:w-full max-w-[75%] mx-auto">
        ...
        {/* Card-1 */}
        <div className="w-[380px] md:w-[450px] lg:w-[350px] p-9 bg-[#192420] rounded-lg relative">
          {/* badge */}
